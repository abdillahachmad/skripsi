...
class JenisMukenaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('jenis_mukena.index')->with('success', 'Jenis mukena berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, Jenis_Mukena $jenis_mukena)
    {
        ...
        return redirect()->route('jenis_mukena.index')->with('success', 'Jenis mukena berhasil diperbarui.');
    }
    ...
    public function destroy(Jenis_Mukena $jenis_mukena) //model
    {
        ...
        return redirect()->route('jenis_mukena.index')->with('success', 'Jenis mukena berhasil dihapus.');
    }
}
